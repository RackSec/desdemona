...
(deftest authenticate-test
  (testing "This test verifies that the authenticate function makes a request to the
...
(deftest create-container-test
  (testing "This test verifies that the create-container function makes a request to the
...
(deftest write-file-test
  (testing "This test verifies that the write-file function makes a request to the URL
...
(deftest swift-write-rows-read-batch-test
  (testing "This test verifies that read-batch calls function/read-batch with the event
...
(deftest swift-write-rows-write-batch-empty-test
  (testing "This test verifies that a batch with no segments does not make any HTTP calls."
